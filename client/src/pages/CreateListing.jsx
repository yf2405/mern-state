    ...
    <main className='p-3 max-w-4xl mx-auto'>
        ...
        <form className='flex flex-col sm:flex-row gap-4'>
            <div className='flex flex-col gap-4 flex-1'>
                ...
                className='border p-3 rounded-lg' id='name' minLength='10' maxLength='62'required />
                <input type="text" placeholder='Description'  
                className='border p-3 rounded-lg' id='Description' minLength='10' maxLength='62' required />
                <input type="text" placeholder='address' 
                className='border p-3 rounded-lg' id='address' minLength='10' maxLength='62' required />
